...
class CustomerCompanyForm(forms.ModelForm):
    tax_code = ITVatNumberField(label=_('Codice Fiscale'))
    vat_code = ITVatNumberField(label=_('Partita IVA'))
    phone = ITPhoneNumberField(label=_('Telefono'))
...
class StaffForm(forms.ModelForm):
    phone = ITPhoneNumberField(label=_('Telefono'), required=False)
...
class CompanySecurityDutyForm(forms.ModelForm):
    internal_phone = ITPhoneNumberField(label=_('Telefono interno'))
    external_phone = ITPhoneNumberField(label=_('Telefono esterno'))
